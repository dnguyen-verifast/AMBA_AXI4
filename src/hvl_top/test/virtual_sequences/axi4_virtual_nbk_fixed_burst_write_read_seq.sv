  ...
  fork 
    begin: T1_WRITE_READ
      repeat(2) begin
        ...
        queue_info_ctrl_h.addr = axi4_master_nbk_write_fixed_burst_seq_h.seq_.awaddr;
        queue_info_ctrl_h.id = axi4_master_nbk_write_fixed_burst_seq_h.seq_.awid;
    ...
    begin: T2_READ
      repeat(3) begin
        ...
        axi4_master_nbk_read_fixed_burst_seq_h.queue_info_ctrl_r.addr = queue_info_ctrl_h1.addr;
        axi4_master_nbk_read_fixed_burst_seq_h.queue_info_ctrl_r.id = queue_info_ctrl_h1.id;  
