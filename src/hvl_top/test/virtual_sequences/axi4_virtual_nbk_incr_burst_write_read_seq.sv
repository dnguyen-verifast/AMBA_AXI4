  ...
  fork 
    begin: T1_WRITE_READ
      repeat(3) begin
        ...
        queue_info_ctrl_h.addr = axi4_master_nbk_write_incr_burst_seq_h.addr;
        queue_info_ctrl_h.id = axi4_master_nbk_write_incr_burst_seq_h.id;
    ...
    begin: T2_READ
      repeat(3) begin
        ...
        axi4_master_nbk_read_incr_burst_seq_h.queue_info_ctrl_r.addr = queue_info_ctrl_h1.addr;
        axi4_master_nbk_read_incr_burst_seq_h.queue_info_ctrl_r.id = queue_info_ctrl_h1.id;
