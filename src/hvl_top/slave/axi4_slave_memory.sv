...
class axi4_slave_memory extends uvm_object;
  ...
  axi4_slave_mem_map_cfg mem_map_cfg;
...
virtual function void axi4_slave_memory::init_default_mem_map_cfg();
  ...
  mem_map_cfg = axi4_slave_mem_map_cfg::type_id::create("mem_map_cfg");

  region_cfg = axi4_slave_mem_region_cfg::type_id::create("REGION_WR_NORMAL");
  ...
  region_cfg = axi4_slave_mem_region_cfg::type_id::create("REGION_RD_NORMAL");
  region_cfg.prot_slave = NORMAL_SECURE_DATA;
  region_cfg.lock_slave = NORMAL_ACCESS;
  region_cfg.data_mode = WRITE_READ_DATA;
