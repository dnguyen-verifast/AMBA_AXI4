...
function void axi4_scoreboard::check_phase(uvm_phase phase);
  ...
  //-------------------------------------------------------
  if((axi4_master_write_address_analysis_fifo.used() == 0) && (axi4_slave_write_address_analysis_fifo.used() == 0) && (axi4_master_tx_awaddr_count == 0) && (axi4_slave_tx_awaddr_count == 0)) begin
    `uvm_info (get_type_name(), $sformatf ("No transactions are captured in write address channel"),UVM_HIGH);
  end
  else if(((axi4_master_write_address_analysis_fifo.used() != 0) || (axi4_slave_write_address_analysis_fifo.used() != 0)) && (axi4_master_tx_awaddr_count == 0) && (axi4_slave_tx_awaddr_count == 0)) begin
    `uvm_error (get_type_name(), $sformatf ("No transactions are compared in write address channel"));
  end
  else if (((axi4_master_write_address_analysis_fifo.used() != 0) || (axi4_slave_write_address_analysis_fifo.used() != 0)) && (axi4_master_tx_awaddr_count != 0) && (axi4_slave_tx_awaddr_count != 0) || (axi4_master_tx_awaddr_count != axi4_slave_tx_awaddr_count)) begin
    `uvm_error (get_type_name(), $sformatf ("No completed transactions are compared in write address channel"));
  end
  else if((axi4_master_write_address_analysis_fifo.used() == 0) && (axi4_slave_write_address_analysis_fifo.used() == 0) && (axi4_master_tx_awaddr_count != 0) && (axi4_slave_tx_awaddr_count != 0)) begin
  ...
  //-------------------------------------------------------
  if((axi4_master_write_data_analysis_fifo.used() == 0) && (axi4_slave_write_data_analysis_fifo.used() == 0) && (axi4_master_tx_wdata_count == 0) && (axi4_slave_tx_wdata_count == 0)) begin
    `uvm_info (get_type_name(), $sformatf ("No transactions are captured in write data channel"),UVM_HIGH);
  end
  else if(((axi4_master_write_data_analysis_fifo.used() != 0) || (axi4_slave_write_data_analysis_fifo.used() != 0)) && (axi4_master_tx_wdata_count == 0) && (axi4_slave_tx_wdata_count == 0)) begin
    `uvm_error (get_type_name(), $sformatf ("No transactions are compared in write data channel"));
  end
  else if (((axi4_master_write_data_analysis_fifo.used() != 0) || (axi4_slave_write_data_analysis_fifo.used() != 0)) && (axi4_master_tx_wdata_count != 0) && (axi4_slave_tx_wdata_count != 0) || (axi4_master_tx_wdata_count != axi4_slave_tx_wdata_count)) begin
    `uvm_error (get_type_name(), $sformatf ("No completed transactions are compared in write data channel"));
  end
  else if((axi4_master_write_data_analysis_fifo.used() == 0) && (axi4_slave_write_data_analysis_fifo.used() == 0) && (axi4_master_tx_wdata_count != 0) && (axi4_slave_tx_wdata_count != 0)) begin
  ...
  //-------------------------------------------------------
  if((axi4_master_write_response_analysis_fifo.used() == 0) && (axi4_slave_write_response_analysis_fifo.used() == 0) && (axi4_master_tx_bresp_count == 0) && (axi4_slave_tx_bresp_count == 0)) begin
    `uvm_info (get_type_name(), $sformatf (" transactions are performed"),UVM_MEDIUM);
  end
  else if(((axi4_master_write_response_analysis_fifo.used() != 0) || (axi4_slave_write_response_analysis_fifo.used() != 0)) && (axi4_master_tx_bresp_count == 0) && (axi4_slave_tx_bresp_count == 0)) begin
    `uvm_error (get_type_name(), $sformatf ("No transactions are compared in write response channel"));
  end
  else if (((axi4_master_write_response_analysis_fifo.used() != 0) || (axi4_slave_write_response_analysis_fifo.used() != 0)) && (axi4_master_tx_bresp_count != 0) && (axi4_slave_tx_bresp_count != 0) || (axi4_master_tx_bresp_count != axi4_slave_tx_bresp_count)) begin
    `uvm_error (get_type_name(), $sformatf ("No completed transactions are compared in write response channel"));
  end
  else if((axi4_master_write_response_analysis_fifo.used() == 0) && (axi4_slave_write_response_analysis_fifo.used() == 0) && (axi4_master_tx_bresp_count != 0) && (axi4_slave_tx_bresp_count != 0)) begin
  ...
  //-------------------------------------------------------
  if((axi4_master_read_address_analysis_fifo.used() == 0) && (axi4_slave_read_address_analysis_fifo.used() == 0) && (axi4_master_tx_araddr_count == 0) && (axi4_slave_tx_araddr_count == 0)) begin
    `uvm_info (get_type_name(), $sformatf ("Write transactions are performed"),UVM_MEDIUM);
  end
  else if(((axi4_master_read_address_analysis_fifo.used() != 0) || (axi4_slave_read_address_analysis_fifo.used() != 0)) && (axi4_master_tx_araddr_count == 0) && (axi4_slave_tx_araddr_count == 0)) begin
    `uvm_error (get_type_name(), $sformatf ("No transactions are compared in read address channel"));
  end
  else if (((axi4_master_read_address_analysis_fifo.used() != 0) || (axi4_slave_read_address_analysis_fifo.used() != 0)) && (axi4_master_tx_araddr_count != 0) && (axi4_slave_tx_araddr_count != 0) || (axi4_master_tx_araddr_count != axi4_slave_tx_araddr_count)) begin
    `uvm_error (get_type_name(), $sformatf ("No completed transactions are compared in read address channel"));
  end
  else if((axi4_master_read_address_analysis_fifo.used() == 0) && (axi4_slave_read_address_analysis_fifo.used() == 0) && (axi4_master_tx_araddr_count != 0) && (axi4_slave_tx_araddr_count != 0)) begin
  ...
  //-------------------------------------------------------
  if((axi4_master_read_data_analysis_fifo.used() == 0) && (axi4_slave_read_data_analysis_fifo.used() == 0) && (axi4_master_tx_rdata_count == 0) && (axi4_slave_tx_rdata_count == 0)) begin
    `uvm_info (get_type_name(), $sformatf ("Write transactions are performed"),UVM_HIGH);
  end
  else if(((axi4_master_read_data_analysis_fifo.used() != 0) || (axi4_slave_read_data_analysis_fifo.used() != 0)) && (axi4_master_tx_rdata_count == 0) && (axi4_slave_tx_rdata_count == 0)) begin
    `uvm_error (get_type_name(), $sformatf ("No transactions are compared in read data channel"));
  end
  else if (((axi4_master_read_data_analysis_fifo.used() != 0) || (axi4_slave_read_data_analysis_fifo.used() != 0)) && (axi4_master_tx_rdata_count != 0) && (axi4_slave_tx_rdata_count != 0) || (axi4_master_tx_rdata_count != axi4_slave_tx_rdata_count)) begin
    `uvm_error (get_type_name(), $sformatf ("No completed transactions are compared in read data channel"));
  end
  else if((axi4_master_read_data_analysis_fifo.used() == 0) && (axi4_slave_read_data_analysis_fifo.used() == 0) && (axi4_master_tx_rdata_count != 0) && (axi4_slave_tx_rdata_count != 0)) begin
