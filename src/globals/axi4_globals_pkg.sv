...
package axi4_globals_pkg;
  ...
  typedef enum bit [1:0] {
    ...
    WRITE_REGION_RD_SECURE = 4'b0011,
    WRITE_REGION_EXCLUSIVE = 4'b0100
  } awregion_e;
	typedef enum bit [3:0]{
    READ_REGION_WR_NORMAL = 4'b0000,
    READ_REGION_WR_SECURE = 4'b0001,
    READ_REGION_RD_NORMAL = 4'b0010,
    READ_REGION_RD_SECURE = 4'b0011,
    READ_REGION_EXCLUSIVE = 4'b0100
  } arregion_e;
